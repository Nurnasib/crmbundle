...
/**
 *
 * @ORM\Table(name="crm_fish_life_cycle_nursing_details")
 * @ORM\Entity(repositoryClass="Terminalbd\CrmBundle\Repository\FishLifeCycleNursingDetailsRepository")
 */
class FishLifeCycleNursingDetails
{
    /**
     * @var integer
    ...
    /**
     * @var FishLifeCycleNursing
     * @ORM\ManyToOne(targetEntity="Terminalbd\CrmBundle\Entity\FishLifeCycleNursing", inversedBy="fishLifeCycleNursingDetails")
     * @ORM\JoinColumn(name="fish_life_cycle_id", referencedColumnName="id")
     * @ORM\JoinColumn(onDelete="CASCADE")
     */

    private $fishLifeCycleNursing;
    ...
    public function getFishLifeCycleNursing()
    {
        return $this->fishLifeCycleNursing;
    }

    public function setFishLifeCycleNursing(FishLifeCycleNursing $fishLifeCycleNursing): void
    {
        $this->fishLifeCycleNursing = $fishLifeCycleNursing;
    }
