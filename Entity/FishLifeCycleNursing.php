...
/**
 *
 * @ORM\Table(name="crm_fish_life_cycle_nursing")
 * @ORM\Entity(repositoryClass="Terminalbd\CrmBundle\Repository\FishLifeCycleNunsingRepository")
 */
class FishLifeCycleNursing
{
    ...
    /**
     * @ORM\ManyToOne(targetEntity="Api" , inversedBy="fishLifeCycleNursing")
    ...
    /**
     * @var FishLifeCycleNursingDetails
     * @ORM\OneToMany(targetEntity="Terminalbd\CrmBundle\Entity\FishLifeCycleNursingDetails", mappedBy="fishLifeCycleNursing")
     */
    private $fishLifeCycleNursingDetails;

    /**
     * @var Setting
     * @ORM\ManyToOne(targetEntity="Setting", inversedBy="fishLifeCycleNursing")
    ...
    /**
     * @var User
     * @ORM\ManyToOne(targetEntity="App\Entity\User" , inversedBy="fishLifeCycleNursing")
     */
    private $employee;

    /**
     * @var Agent
     * @ORM\ManyToOne(targetEntity="App\Entity\Core\Agent" , inversedBy="fishLifeCycleNursing")
     */
    private $agent;

    /**
     * @var CrmCustomer
     * @ORM\ManyToOne(targetEntity="CrmCustomer", inversedBy="fishLifeCycleNursing")
     */
    private $customer;
    ...
    public function getFishLifeCycleNursingDetails()
    {
        return $this->fishLifeCycleNursingDetails;
    }

    public function setFishLifeCycleNursingDetails(FishLifeCycleNursingDetails $fishLifeCycleNursingDetails): void
    {
        $this->fishLifeCycleNursingDetails = $fishLifeCycleNursingDetails;
    }
     ...
     */
    public function setOtherCultureSpecies(?Setting $otherCultureSpecies): void
    {
