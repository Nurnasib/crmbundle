 ...
 */
class DairyLifeCycleDetailsFormType extends AbstractType
{
    ...
    public function buildForm(FormBuilderInterface $builder, array $options): void
    {
        ...
        $builder
            ...
            ->add('lactation_no', NumberType::class, [
                'attr' => ['autofocus' => true],
                'label' => 'label.lactation_no',
                'required'=>false
            ])
            ->add('age_of_lactation', NumberType::class, [
                'attr' => ['autofocus' => true],
                'label' => 'label.age_of_lactation',
                'required'=>false
            ])
            ->add('average_weight_per_day', NumberType::class, [
                'attr' => ['autofocus' => true],
                'label' => 'label.average_weight_per_day',
                'required'=>false
            ])
            ->add('milk_fat_percentage', NumberType::class, [
                'attr' => ['autofocus' => true],
                'label' => 'label.milk_fat_percentage',
                'required'=>false
            ])
