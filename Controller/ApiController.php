    ...
    public function createFarmer(Request $request, ParameterBagInterface $parameterBag)
    {
        ...
        if ($request->getMethod() == 'POST' && $request->headers->get('X-API-KEY') == $parameterBag->get('crm_api_key')) {
            ...
            if (
                ...
                ((isset($parameters['agentId']) && $parameters['agentId'] !== null) || (isset($parameters['subAgentId']) && $parameters['subAgentId'] !== null) || (isset($parameters['otherAgentId']) && $parameters['otherAgentId'] !== null)) &&
