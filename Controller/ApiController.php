                            ...
                            foreach ($entity->getCrmChickLifeCycleDetails() as $lifeCycleDetail) {
                                if($lifeCycleDetail->getReportingDate()!=""){
                                    ...
                                    $arrayData[]=[
                                        ...
                                        "mortality_percent"=> $lifeCycleDetail->calculateMortalityPercent()>0? (string)$lifeCycleDetail->calculateMortalityPercent():"0",
                                        ...
                                        "without_mortality"=> $lifeCycleDetail->calculateWithoutMortality()>0? (string)$lifeCycleDetail->calculateWithoutMortality():"0",
                                        "with_mortality"=> $lifeCycleDetail->calculateWithMortality()>0? (string)$lifeCycleDetail->calculateWithMortality():"0",
