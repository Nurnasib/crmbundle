                            ...
                            foreach ($entity->getCrmChickLifeCycleDetails() as $lifeCycleDetail) {
                                if($lifeCycleDetail->getReportingDate()!=""){
                                    ...
                                    $arrayData[]=[
                                        ...
                                        "created_at"=> $lifeCycleDetail->getCreatedAt()&&$lifeCycleDetail->getCreatedAt()!='0000-00-00 00:00:00'?$lifeCycleDetail->getCreatedAt()->format('Y-m-d H:i:s'):$reportingMonth,
                ...
                if($entities){
                    ...
                    foreach ($entities as $entity) {
                        ...
                        $arrayData[]=[
                            ...
                            "culture_area_decimal"=> $entity->getCultureAreaDecimal()?(string)$entity->getCultureAreaDecimal():"",
                            "no_of_initial_fish_pcs"=> $entity->getNoOfInitialFish()?(string)$entity->getNoOfInitialFish():"",
                            "density_per_decimal_pcs"=> $entity->getStockingDensity()?(string)$entity->getStockingDensity():"",
                            "avg_initial_weight_gm"=> $entity->getAverageInitialWeightGm()?(string)$entity->getAverageInitialWeightGm():"",
                            "total_initial_weight_kg"=> $entity->getTotalInitialWeightKg()?(string)$entity->getTotalInitialWeightKg():"",
